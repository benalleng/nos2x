(() => {
  ...
  var require_utils = __commonJS({
    "node_modules/des.js/lib/des/utils.js"(exports) {
      ...
      exports.rip = function rip(inL, inR, out, off2) {
        var outL = 0;
        var outR = 0;
        for (var i = 0; i < 4; i++) {
      ...
      exports.pc1 = function pc1(inL, inR, out, off2) {
        var outL = 0;
        var outR = 0;
        for (var i = 7; i >= 5; i--) {
          for (var j = 0; j <= 24; j += 8) {
      ...
      exports.pc2 = function pc2(inL, inR, out, off2) {
        var outL = 0;
        var outR = 0;
      ...
      exports.expand = function expand(r, out, off2) {
        var outL = 0;
        var outR = 0;
        outL = (r & 1) << 5 | r >>> 27;
  ...
  var require_cipher = __commonJS({
    "node_modules/des.js/lib/des/cipher.js"(exports, module2) {
      "use strict";
      init_virtual_process_polyfill();
      init_buffer();
      ...
      Cipher.prototype._pad = function _pad(buffer, off2) {
        if (off2 === 0)
          return false;
        while (off2 < buffer.length)
          buffer[off2++] = 0;
        return true;
      };
  ...
  var require_des = __commonJS({
    "node_modules/des.js/lib/des/des.js"(exports, module2) {
      "use strict";
      init_virtual_process_polyfill();
      init_buffer();
      var assert = require_minimalistic_assert();
      ...
      DES.prototype._pad = function _pad(buffer, off2) {
        var value = buffer.length - off2;
        for (var i = off2; i < buffer.length; i++)
          buffer[i] = value;
        return true;
      };
  ...
  var require_ede = __commonJS({
    "node_modules/des.js/lib/des/ede.js"(exports, module2) {
      "use strict";
      init_virtual_process_polyfill();
      init_buffer();
      var assert = require_minimalistic_assert();
  ...
  var require_browserify_des = __commonJS({
    "node_modules/browserify-des/index.js"(exports, module2) {
      init_virtual_process_polyfill();
      init_buffer();
  ...
  var require_cfb = __commonJS({
    "node_modules/browserify-aes/modes/cfb.js"(exports) {
      ...
      function encryptStart(self2, data, decrypt2) {
        ...
        self2._prev = Buffer5.concat([self2._prev, decrypt2 ? data : out]);
        return out;
      }
      exports.encrypt = function(self2, data, decrypt2) {
        ...
        while (data.length) {
          ...
          if (self2._cache.length <= data.length) {
            ...
            out = Buffer5.concat([out, encryptStart(self2, data.slice(0, len), decrypt2)]);
            data = data.slice(len);
          } else {
            out = Buffer5.concat([out, encryptStart(self2, data, decrypt2)]);
            break;
          }
        }
        return out;
    ...
    "node_modules/browserify-aes/modes/cfb8.js"(exports) {
      ...
      function encryptByte(self2, byteParam, decrypt2) {
        ...
        self2._prev = Buffer5.concat([
          self2._prev.slice(1),
          Buffer5.from([decrypt2 ? byteParam : out])
        ]);
        return out;
      }
  ...
  var require_cfb1 = __commonJS({
    "node_modules/browserify-aes/modes/cfb1.js"(exports) {
      ...
      function shiftIn(buffer, value) {
        ...
        var i = -1;
        var out = Buffer5.allocUnsafe(buffer.length);
        buffer = Buffer5.concat([buffer, Buffer5.from([value])]);
        while (++i < len) {
  ...
  var require_aes = __commonJS({
    "node_modules/browserify-aes/aes.js"(exports, module2) {
      ...
      AES.prototype.encryptBlock = function(M) {
        ...
        var buf = Buffer5.allocUnsafe(16);
  ...
  var require_ghash = __commonJS({
    "node_modules/browserify-aes/ghash.js"(exports, module2) {
      ...
      GHASH.prototype.update = function(buf) {
        this.cache = Buffer5.concat([this.cache, buf]);
        var chunk;
  ...
  var require_authCipher = __commonJS({
    "node_modules/browserify-aes/authCipher.js"(exports, module2) {
      ...
      function StreamCipher(mode, key, iv, decrypt2) {
        Transform.call(this);
        var h = Buffer5.alloc(4, 0);
        this._cipher = new aes2.AES(key);
      ...
      StreamCipher.prototype.getAuthTag = function getAuthTag() {
        if (this._decrypt || !Buffer5.isBuffer(this._authTag))
  ...
  var require_evp_bytestokey = __commonJS({
    "node_modules/evp_bytestokey/index.js"(exports, module2) {
      ...
      function EVP_BytesToKey(password, salt, keyBits, ivLen) {
        if (!Buffer5.isBuffer(password))
          password = Buffer5.from(password, "binary");
        if (salt) {
          if (!Buffer5.isBuffer(salt))
            salt = Buffer5.from(salt, "binary");
          if (salt.length !== 8)
    ...
    "node_modules/browserify-aes/encrypter.js"(exports) {
      ...
      function createCipheriv(suite, password, iv) {
        ...
        if (typeof password === "string")
          password = Buffer5.from(password);
  ...
  var require_browser5 = __commonJS({
    "node_modules/browserify-cipher/browser.js"(exports) {
      ...
      function createCipheriv(suite, key, iv) {
        suite = suite.toLowerCase();
        if (aesModes[suite])
          return aes2.createCipheriv(suite, key, iv);
        if (desModes[suite])
      ...
      function createDecipheriv(suite, key, iv) {
        suite = suite.toLowerCase();
        if (aesModes[suite])
          return aes2.createDecipheriv(suite, key, iv);
        if (desModes[suite])
  ...
  // node_modules/nostr-tools/index.js
  init_virtual_process_polyfill();
  init_buffer();

  // node_modules/nostr-tools/keys.js
  init_virtual_process_polyfill();
  init_buffer();
  ...
  function getPublicKey(privateKey) {
    return Buffer2.from(schnorr.getPublicKey(privateKey)).toString("hex");
  }
  ...
  async function signEvent(event, key) {
    return import_buffer.Buffer.from(await schnorr.sign(getEventHash(event), key)).toString("hex");
  }
  ...
  // node_modules/nostr-tools/nip04.js
  init_virtual_process_polyfill();
  init_buffer();
  var import_browserify_cipher = __toESM(require_browser5());
  ...
  function encrypt(privkey, pubkey, text) {
    ...
    var cipher = import_browserify_cipher.default.createCipheriv("aes-256-cbc", import_buffer2.Buffer.from(normalizedKey, "hex"), iv);
    let encryptedMessage = cipher.update(text, "utf8", "base64");
    encryptedMessage += cipher.final("base64");
    return `${encryptedMessage}?iv=${import_buffer2.Buffer.from(iv.buffer).toString("base64")}`;
  }
  function decrypt(privkey, pubkey, ciphertext) {
    let [cip, iv] = ciphertext.split("?iv=");
    let key = getSharedSecret(privkey, "02" + pubkey);
    let normalizedKey = getNormalizedX(key);
    var decipher = import_browserify_cipher.default.createDecipheriv("aes-256-cbc", import_buffer2.Buffer.from(normalizedKey, "hex"), import_buffer2.Buffer.from(iv, "base64"));
    let decryptedMessage = decipher.update(cip, "base64");
    decryptedMessage += decipher.final("utf8");
    return decryptedMessage;
  }
  function getNormalizedX(key) {
    return typeof key === "string" ? key.substr(2, 64) : import_buffer2.Buffer.from(key.slice(1, 33)).toString("hex");
  }
  ...
  var Semaphore = class {
    ...
    runExclusive(callback) {
      return __awaiter$2(this, void 0, void 0, function* () {
        const [value, release2] = yield this.acquire();
        try {
  ...
  async function readPermissions() {
    let { permissions = {} } = await import_webextension_polyfill.default.storage.local.get("permissions");
    ...
    if (needsUpdate)
      import_webextension_polyfill.default.storage.local.set({ permissions });
    return permissions;
  }
